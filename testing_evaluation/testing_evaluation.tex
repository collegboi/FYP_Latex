...
The evaluation was done by two outsourced developers, by using the test example project. The evaluation feedback from both developers are included in the case chapter until section evaluation.